      ...
      <aside className="relative hidden overflow-hidden bg-primary p-12 lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative max-w-md text-surface">
          ...
          <p className="mt-4 text-sm leading-relaxed text-surface/80">
            A community-powered platform for reporting and tracking issues in your barangay —
            transparent, verified, and fast.
          </p>

          {/* Feature pills */}
          <div className="mt-6 flex flex-wrap gap-2">
            <span className="rounded-full border border-surface/20 bg-surface/10 px-3 py-1 text-xs font-medium text-surface">
              Verified reports
            </span>
            <span className="rounded-full border border-surface/20 bg-surface/10 px-3 py-1 text-xs font-medium text-surface">
              Live tracking
        ...
        {/* Bottom credit */}
        <div className="relative text-xs text-surface/60">© {new Date().getFullYear()} Bantay PH</div>
      </aside>
